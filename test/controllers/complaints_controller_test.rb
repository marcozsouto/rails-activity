...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { category: @complaint.category, company: @complaint.company, text: @complaint.text, title: @complaint.title, user_id: @complaint.user_id } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { category: @complaint.category, company: @complaint.company, text: @complaint.text, title: @complaint.title, user_id: @complaint.user_id } }
